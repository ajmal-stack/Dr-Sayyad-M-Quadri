...
/**
 * Dr. Syed M Quadri Backend Server
 * Mental Health & Medical Practice API
 */
class Server {
  constructor() {
    this.app = express();
  ...
  setupRoutes() {
    ...
    this.app.get('/', (req, res) => {
      res.json({
        message: 'Dr. Syed M Quadri Backend API',
        description: 'Mental Health & Medical Practice API Server',
        version: '1.0.0',
  ...
  async start() {
    try {
      ...
      this.app.listen(this.port, () => {
        console.log('🚀 =====================================');
        console.log(`🏥 Dr. Syed M Quadri Backend Server`);
        console.log('🚀 =====================================');
