...
export const config = {
  ...
  database: {
    uri: process.env.MONGODB_URI || 'mongodb://localhost:27017/dr-quadri-db',
    options: {
  ...
  cloudinary: {
    ...
    folder: process.env.CLOUDINARY_FOLDER || 'dr-quadri',
  },
  ...
  email: {
    ...
    from: {
      ...
      name: process.env.FROM_NAME || 'Dr. Syed M Quadri',
    },
    sendgrid: {
