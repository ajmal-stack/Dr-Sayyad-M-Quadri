...
import treatmentCategoryRoutes from '../../modules/treatment/routes/categoryRoutes.js';
...
console.log('🔧 Loading treatment category routes...');
router.use('/treatment-categories', treatmentCategoryRoutes);
console.log('✅ Treatment category routes loaded');
