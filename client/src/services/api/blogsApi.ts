  ...
  async getCategories(): Promise<{ success: boolean; data: Array<{ category: string; count: number }> }> {
    try {
      ...
      return {
        success: true,
        data: [
          { category: 'Mental Health', count: 0 },
          { category: 'General Health', count: 0 },
          { category: 'Cardiovascular Health', count: 0 },
          { category: 'Preventive Care', count: 0 },
          { category: 'Lifestyle Medicine', count: 0 },
          { category: 'Diabetes Care', count: 0 }
        ]
      };
    }
  }
