...
const categories = [
  { name: 'All', value: 'all' },
  { name: 'General Health', value: 'General Health' },
      ...
      <section className="py-16 bg-gradient-to-br from-blue-50 to-indigo-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Get the latest medical insights, health tips, and evidence-based articles from Dr. Syed M Quadri delivered to your inbox.
          </p>
