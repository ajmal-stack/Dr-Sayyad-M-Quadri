...
export default function NotFound() {
  ...
  const quickLinks = [
    ...
    {
      name: 'About Dr. Quadri',
      href: '/about',
      icon: UserIcon,
      description: 'Learn about our psychiatrist',
    ...
    },
    {
      ...
      href: '/books',
      icon: BookOpenIcon,
      description: 'Explore mental health books',
    ...
    },
    {
      ...
      href: '/podcast',
      icon: MicrophoneIcon,
      description: 'Listen to therapeutic discussions',
            ...
            <div className='flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6'>
              ...
              <div className='text-center sm:text-left'>
                ...
                <p className='text-sm sm:text-base text-slate-600 mb-3 sm:mb-4 leading-relaxed'>
                  If you&apos;re in crisis or need immediate help, don&apos;t
                ...
                <div className='flex flex-col sm:flex-row gap-2 sm:gap-3'>
                  ...
                  <a
                    href='tel:988'
                    className='inline-flex items-center justify-center px-3 sm:px-4 py-2 bg-red-600 text-white rounded-lg font-medium hover:bg-red-700 transition-colors text-xs sm:text-sm'
                  >
                    Crisis Hotline: 988
                  </a>
                </div>
