...
//   { name: "Attention-Deficit/Hyperactivity Disorder (ADHD)", href: "/treatment/adhd", active: true },
...
const onThisPageItems = [
  { name: "What is ADHD?", href: "#what-is-adhd" },
  { name: "Where can I learn more about ADHD?", href: "#learn-more" },
  { name: "Why is NIMH studying ADHD?", href: "#why-nimh-studying" },
  { name: "How is NIMH research addressing this critical topic?", href: "#nimh-research" },
  { name: "Explore clinical trials about ADHD", href: "#clinical-trials" },
  { name: "Share outreach materials about ADHD", href: "#share-materials" },
...
const informationCards = [
  {
    ...
    description: "Brochures and fact sheets with more information about ADHD, including signs, symptoms, and treatment options. Available for free in print and online.",
    icon: BookOpenIcon,
    bgColor: "bg-blue-500"
  },
  {
    title: "Science updates", 
    description: "NIMH news about ADHD, including press releases and highlights on the latest research findings.",
    icon: NewspaperIcon,
    bgColor: "bg-blue-500"
  },
  {
    title: "Statistics",
    description: "Information about the prevalence and treatment of ADHD in the United States.",
    icon: ChartBarIcon,
    bgColor: "bg-blue-500"
  }
];
    ...
    <div className="min-h-screen pt-18 bg-white">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-gray-900 font-medium truncate">ADHD</span>
          </nav>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid lg:grid-cols-4 gap-8">
          {/* Left Sidebar */}
          <TreatmentSidebar currentPage="/treatment/adhd" />

          {/* Main Content */}
          <div className="lg:col-span-2">
            {/* Header */}
            <div className="mb-8">
              <h1 className="text-4xl font-bold text-gray-900 mb-8">Attention-Deficit/Hyperactivity Disorder (ADHD)</h1>
            ...
            {/* What is ADHD? */}
            <section id="what-is-adhd" className="mb-12">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">What is ADHD?</h2>
                ...
                <div className="lg:col-span-2">
                  <div className="prose prose-lg text-gray-600 space-y-4">
                    <p className="text-base leading-relaxed">
                      ...
                      persistent patterns of inattention and/or hyperactivity-impulsivity that interfere with functioning 
                      or development. ADHD symptoms appear before age 12 and continue into adulthood.
                    </p>
                    
                    <p className="text-base leading-relaxed">ADHD has three main symptom categories:</p>
                ...
                <div className="lg:col-span-1">
                  <div className="bg-gray-100 rounded-lg p-4 aspect-video flex items-center justify-center border">
                    <div className="text-center">
                      ...
                      <p className="text-sm text-gray-600 font-medium">Mental Health Minute: ADHD</p>
            ...
            <section id="learn-more" className="mb-12">
              <h2 className="text-2xl font-bold text-gray-900 mb-8">Where can I learn more about ADHD?</h2>
            ...
            <section id="why-nimh-studying" className="mb-12">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Why is NIMH studying ADHD?</h2>
              <div className="prose prose-lg text-gray-600 space-y-4">
                <p className="text-base leading-relaxed">
                  ADHD is one of the most common neurodevelopmental disorders of childhood. It is usually first diagnosed 
                  in childhood and often lasts into adulthood. <a href="#" className="text-blue-600 hover:text-blue-800">About 6 million children</a> ages 
                  3-17 years have been diagnosed with ADHD.
                </p>
                <p className="text-base leading-relaxed">
                  ADHD can significantly impact academic performance, social relationships, and daily functioning. 
                  Understanding the causes, developing better diagnostic tools, and improving treatments are essential 
                  for helping individuals with ADHD reach their full potential.
                </p>
              </div>
            </section>
            ...
            <section id="nimh-research" className="mb-12">
              ...
              <div className="prose prose-lg text-gray-600 space-y-4">
                <p className="text-base leading-relaxed">
                  NIMH supports research to understand the brain mechanisms underlying ADHD, develop better diagnostic 
                  methods, and create more effective treatments. Research areas include studying brain development, 
                  genetic factors, and environmental influences.
                </p>
                
                <p className="text-base leading-relaxed">
                  Current studies focus on understanding attention networks in the brain, investigating medication effects, 
                  testing behavioral interventions, and exploring how ADHD symptoms change across the lifespan.
                </p>
                
                <p className="text-base leading-relaxed">
                  NIMH also supports research on ADHD in adults, co-occurring conditions, and innovative treatment 
                  approaches including digital therapeutics and personalized medicine strategies.
                </p>
              </div>
            </section>
            ...
            <section id="clinical-trials" className="mb-12">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Explore clinical trials about ADHD</h2>
              <div className="text-gray-600">
                ...
                <ul className="list-disc pl-6 space-y-2 text-base">
                  ...
                  <li><a href="#" className="text-blue-600 hover:text-blue-800">Clinicaltrials.gov: Current Studies on ADHD</a></li>
                  <li><a href="#" className="text-blue-600 hover:text-blue-800">NIMH ADHD Studies for Adults</a></li>
                  <li><a href="#" className="text-blue-600 hover:text-blue-800">NIMH ADHD Studies for Children</a></li>
                </ul>
              </div>
            </section>
              ...
              <div className="text-gray-600">
                <ul className="space-y-2">
                  <li className="text-base">
                    <strong><a href="#" className="text-blue-600 hover:text-blue-800">ADHD</a></strong> (MedlinePlus): Information, journal articles, and other resources about ADHD collected by the National Library of Medicine
                  </li>
                </ul>
              </div>
            </section>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-blue-600 rounded-lg p-6 text-white">
                <div className="flex items-start mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-sm leading-tight">Sign up for email updates about ADHD</h3>
                  </div>
                </div>
                <button 
