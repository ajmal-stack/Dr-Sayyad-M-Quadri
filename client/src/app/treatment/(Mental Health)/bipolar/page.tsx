...
//   { name: "Bipolar Disorder", href: "/treatment/bipolar", active: true },
...
const onThisPageItems = [
  { name: "What is bipolar disorder?", href: "#what-is-bipolar" },
  { name: "Where can I learn more about bipolar disorder?", href: "#learn-more" },
  { name: "Why is NIMH studying bipolar disorder?", href: "#why-nimh-studying" },
  { name: "How is NIMH research addressing this critical topic?", href: "#nimh-research" },
  { name: "Explore clinical trials about bipolar disorder", href: "#clinical-trials" },
  { name: "Share outreach materials about bipolar disorder", href: "#share-materials" },
...
const informationCards = [
  {
    ...
    description: "Brochures and fact sheets with more information about bipolar disorder, including signs, symptoms, and treatment options. Available for free in print and online.",
    icon: BookOpenIcon,
    bgColor: "bg-blue-500"
  },
  {
    title: "Science updates", 
    description: "NIMH news about bipolar disorder, including press releases and highlights on the latest research findings.",
    icon: NewspaperIcon,
    bgColor: "bg-blue-500"
  },
  {
    title: "Statistics",
    description: "Information about the prevalence and treatment of bipolar disorder in the United States.",
    icon: ChartBarIcon,
    bgColor: "bg-blue-500"
  }
];
...
export default function BipolarNIMHPage() {
    ...
    <div className="min-h-screen pt-18 bg-white">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-gray-900 font-medium truncate">Bipolar Disorder</span>
          </nav>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid lg:grid-cols-4 gap-8">
          {/* Left Sidebar */}
          <TreatmentSidebar currentPage="/treatment/bipolar" />

          {/* Main Content */}
          <div className="lg:col-span-2">
            {/* Header */}
            <div className="mb-8">
              <h1 className="text-4xl font-bold text-gray-900 mb-8">Bipolar Disorder</h1>
            ...
            <section id="what-is-bipolar" className="mb-12">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">What is bipolar disorder?</h2>
                ...
                <div className="lg:col-span-2">
                  <div className="prose prose-lg text-gray-600 space-y-4">
                    <p className="text-base leading-relaxed">
                      ...
                      emotional highs (mania or hypomania) and lows (depression). These mood episodes cause significant 
                      changes in energy, activity levels, concentration, and the ability to carry out day-to-day tasks.
                    </p>
                    
                    <p className="text-base leading-relaxed">There are several types of bipolar disorder, including:</p>
                    
                    <ul className="list-disc pl-6 space-y-2">
                      {bipolarTypes.map((type) => (
                ...
                <div className="lg:col-span-1">
                  <div className="bg-gray-100 rounded-lg p-4 aspect-video flex items-center justify-center border">
                    <div className="text-center">
                      ...
                      <p className="text-sm text-gray-600 font-medium">Mental Health Minute: Bipolar Disorder</p>
            ...
            <section id="learn-more" className="mb-12">
              <h2 className="text-2xl font-bold text-gray-900 mb-8">Where can I learn more about bipolar disorder?</h2>
            ...
            <section id="why-nimh-studying" className="mb-12">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Why is NIMH studying bipolar disorder?</h2>
              <div className="prose prose-lg text-gray-600 space-y-4">
                <p className="text-base leading-relaxed">
                  Bipolar disorder affects <a href="#" className="text-blue-600 hover:text-blue-800">about 2.8% of U.S. adults</a> each 
                  year, and it typically begins in late adolescence or early adulthood. The condition can cause significant 
                  impairment in social, occupational, and other important areas of functioning.
                </p>
                <p className="text-base leading-relaxed">
                  Understanding the biological mechanisms of bipolar disorder, developing more effective treatments, 
                  and improving early detection are critical for helping people with this condition live full, productive lives.
                </p>
              </div>
            </section>
            ...
            <section id="nimh-research" className="mb-12">
              ...
              <div className="prose prose-lg text-gray-600 space-y-4">
                <p className="text-base leading-relaxed">
                  NIMH supports research to understand the brain circuits and genetic factors involved in bipolar disorder. 
                  Studies focus on mood regulation, brain imaging, genetic risk factors, and the development of new therapeutic approaches.
                </p>
                
                <p className="text-base leading-relaxed">
                  Research areas include investigating lithium and other mood stabilizers, studying circadian rhythms, 
                  developing digital health tools for mood monitoring, and exploring psychosocial interventions.
                </p>
                
                <p className="text-base leading-relaxed">
                  NIMH also supports research on suicide prevention in bipolar disorder, treatment of co-occurring substance 
                  use disorders, and strategies to improve medication adherence and long-term outcomes.
                </p>
              </div>
            </section>
            ...
            <section id="clinical-trials" className="mb-12">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Explore clinical trials about bipolar disorder</h2>
              <div className="text-gray-600">
                ...
                <ul className="list-disc pl-6 space-y-2 text-base">
                  ...
                  <li><a href="#" className="text-blue-600 hover:text-blue-800">Clinicaltrials.gov: Current Studies on Bipolar Disorder</a></li>
                  <li><a href="#" className="text-blue-600 hover:text-blue-800">NIMH Bipolar Disorder Studies for Adults</a></li>
                  <li><a href="#" className="text-blue-600 hover:text-blue-800">NIMH Bipolar Disorder Studies for Children</a></li>
                </ul>
              </div>
            </section>
              ...
              <div className="text-gray-600">
                <ul className="space-y-2">
                  <li className="text-base">
                    <strong><a href="#" className="text-blue-600 hover:text-blue-800">Bipolar Disorder</a></strong> (MedlinePlus): Information, journal articles, and other resources about bipolar disorder collected by the National Library of Medicine
                  </li>
                </ul>
              </div>
            </section>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-blue-600 rounded-lg p-6 text-white">
                <div className="flex items-start mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-sm leading-tight">Sign up for email updates about bipolar disorder</h3>
                  </div>
                </div>
                <button 
