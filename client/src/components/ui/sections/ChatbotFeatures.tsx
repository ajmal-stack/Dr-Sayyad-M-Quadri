...
const features = [
  {
    ...
    description: 'Instant responses from the chatbot within 6 seconds - never leave patients waiting.',
    gradient: 'from-purple-500 to-blue-600',
  },
  {
    icon: ClockIcon,
    title: '24/7 Available',
    description: 'Round-the-clock mental health support when your patients need it most.',
    gradient: 'from-blue-500 to-indigo-600',
  },
  {
    icon: ChatBubbleLeftRightIcon,
    title: 'Intelligent Conversations',
    description: 'Powered by advanced AI to provide helpful, empathetic responses about mental health.',
    gradient: 'from-indigo-500 to-purple-600',
  },
  {
    icon: ShieldCheckIcon,
    title: 'HIPAA Compliant',
    description: 'Industry-leading security and privacy standards to protect patient information.',
    gradient: 'from-green-500 to-emerald-600',
  },
  {
    icon: LanguageIcon,
    title: 'Multilingual Support',
    description: 'Communicate with patients in their preferred language for better care.',
    gradient: 'from-orange-500 to-red-600',
  },
  {
    icon: ChartBarIcon,
    title: 'Analytics Dashboard',
    description: 'Track patient interactions and optimize your mental health services.',
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative'>
        ...
        >
          <div className='inline-flex items-center bg-gradient-to-r from-purple-500/20 to-blue-500/20 text-blue-200 px-6 py-3 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm border border-blue-400/20'>
            ...
            <span>AI-Powered Mental Health Assistant</span>
          </div>
          ...
          <p className='text-xl text-blue-200 max-w-4xl mx-auto leading-relaxed'>
            Stop wasting precious time on repetitive questions. Let our GPT-4 powered chatbot learn 
            from your practice data and handle patient inquiries 24/7.
          </p>
          <div className='mt-8'>
            <button
        ...
        >
          <div className='text-center'>
            ...
            <div className='text-blue-300'>Mental Health Practices</div>
          </div>
          <div className='text-center'>
            <div className='text-3xl lg:text-4xl font-bold text-white mb-2'>32,000+</div>
            <div className='text-blue-300'>Patient Conversations</div>
          </div>
          <div className='text-center'>
        ...
        >
          <div className='text-lg text-blue-200 mb-6 italic leading-relaxed'>
            "The AI assistant has revolutionized how we handle patient inquiries. Our staff can now focus 
            on providing quality care instead of answering the same questions repeatedly. It's been a 
            game-changer for our practice efficiency."
          </div>
          <div className='text-white font-semibold'>Dr. Sarah Johnson</div>
          <div className='text-blue-300 text-sm'>Psychiatric Practice, Dallas</div>
        </div>
      </div>
    </section>
  );
