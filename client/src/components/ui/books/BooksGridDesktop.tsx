...
export default function BooksGridDesktop({ items, className = '' }: BooksGridDesktopProps) {
  ...
  const handlePlay = (item: Book) => {
    ...
    const audioUrl = '/audio/audiobook-sample.mp3'; // Placeholder
                  ...
                  <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[4]'>
                    <button
                      ...
                      className='
                        ...
                        p-3 transition-all duration-300 hover:scale-110 shadow-lg
                        touch-manipulation
                      '
                    >
