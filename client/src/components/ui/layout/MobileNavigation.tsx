...
export default function MobileNavigation({
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className='sticky top-0 z-20 bg-blue-600 border-b border-blue-700'>
          <div className='flex items-center justify-between p-4'>
            <div className='flex items-center space-x-3'>
              ...
              <div>
                <div className='font-semibold text-white'>Dr. Syed M Quadri</div>
                <div className='text-sm text-blue-100'>Mental Health Expert</div>
              </div>
            </div>
            <button
              onClick={() => setIsOpen(false)}
