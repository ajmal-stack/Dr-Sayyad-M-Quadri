...
const navItems: NavItem[] = [
  {
    ...
    dropdownItems: [
      ...
      },
      {
        ...
        href: '/podcast#trending-episodes',
      ...
      },
      {
        ...
        href: '/podcast#podcast-membership',
  ...
  },
  {
    ...
    //     href: '/treatment/ocd',
    //     featured: true,
    //     description: 'Obsessive-Compulsive Disorder therapy and support',
    ...
    //     featured: true,
    //     description: 'Comprehensive anxiety management and therapy',
    //     icon: <ExclamationTriangleIcon className='w-4 h-4' />,
    //   },
    //   {
    //     name: 'Depression Treatment',
    //     href: '/treatment/depression',
    //     featured: true,
    //     description: 'Professional depression therapy and counseling',
    //     icon: <CloudIcon className='w-4 h-4' />,
    //   },
    //   {
    //     name: 'Relationship Therapy',
    //     href: '/treatment/relationship',
    //     featured: true,
    //     description: 'Couples and relationship counseling services',
    //     icon: <UsersIcon className='w-4 h-4' />,
    //   },
    //   {
    //     name: 'Stress Management',
    //     href: '/treatment/stress',
    //     featured: true,
    //     description: 'Effective stress reduction techniques and therapy',
    ...
    //     featured: true,
    //     description: 'Sleep disorders and insomnia therapy',
    //     icon: <MoonIcon className='w-4 h-4' />,
    //   },
    //   {
    //     name: 'Anger Management',
    //     href: '/treatment/anger',
    //     featured: true,
    //     description: 'Professional anger management counseling',
    //     icon: <FireIcon className='w-4 h-4' />,
    //   },
    //   {
    //     name: 'Phobia Treatment',
    //     href: '/treatment/phobia',
    //     featured: true,
    //     description: 'Specialized phobia and fear therapy',
