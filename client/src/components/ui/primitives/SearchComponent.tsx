...
const searchData: SearchResult[] = [
  ...
  // Videos
  {
    ...
    views: '125K',
    category: 'Mental Health',
    url: '/youtube/understanding-anxiety',
  },
  {
    id: 'video-2',
    ...
    views: '89K',
    category: 'Treatment',
    url: '/youtube/depression-treatment',
  },
  {
    id: 'video-3',
    ...
    views: '156K',
    category: 'Parenting',
    url: '/youtube/parenting-mental-health',
  },
  ...
  // Podcasts
  {
    ...
    duration: '45:30',
    category: 'Mental Health',
    url: '/podcast/digital-age-mental-health',
  },
  {
    id: 'podcast-2',
  ...
  },
  {
    ...
    duration: '38:45',
    category: 'Anxiety',
    url: '/podcast/anxiety-management',
  },
...
export default function SearchComponent({
  ...
  onClose,
  variant = 'dropdown',
  placeholder = 'Search podcasts, books, videos, topics...',
        ...
        <div className='p-3 sm:p-4 border-b border-slate-100 bg-white'>
          ...
          <div className='flex items-center space-x-1 sm:space-x-2 mt-2 sm:mt-3 overflow-x-auto scrollbar-hide'>
            {[
              ...
              { key: 'video', label: 'Videos', icon: <VideoCameraIcon className='w-3 h-3' /> },
              { key: 'podcast', label: 'Podcasts', icon: <SpeakerWaveIcon className='w-3 h-3' /> },
