...
export default function MobileSearch({
  isOpen,
  onClose,
  placeholder = 'Search podcasts, books, videos...',
}: MobileSearchProps) {
        ...
        <div className='px-4 py-3 border-b border-slate-200 bg-white'>
          ...
          <div className='flex items-center space-x-2 overflow-x-auto scrollbar-hide'>
            {[
              ...
              { key: 'video', label: 'Videos', icon: <VideoCameraIcon className='w-4 h-4' /> },
              { key: 'podcast', label: 'Podcasts', icon: <SpeakerWaveIcon className='w-4 h-4' /> },
